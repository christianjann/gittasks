package io.github.christianjann.gitnotecje.ui.screen.setup.remote
...
import io.github.christianjann.gitnotecje.provider.RepoInfo
import io.github.christianjann.gitnotecje.provider.UserInfo
import io.github.christianjann.gitnotecje.ui.component.AppPage
import io.github.christianjann.gitnotecje.ui.component.SetupButton
import io.github.christianjann.gitnotecje.ui.component.SetupPage
...
import io.github.christianjann.gitnotecje.ui.viewmodel.SetupViewModelI
import io.github.christianjann.gitnotecje.ui.viewmodel.SetupViewModelMock
import io.github.christianjann.gitnotecje.utils.contains
...
private fun PickRepoScreenPreview() {
    PickRepoScreen(
        ...
        repos = listOf(
            RepoInfo(name = "repoName1", owner = "chris", url = "repoName1", 0),
            RepoInfo(name = "repoName2", owner = "chris", url = "repoName1", 1),
            RepoInfo(name = "repoName3", owner = "chris", url = "repoName1", 2),
            RepoInfo(name = "repoName4", owner = "chris", url = "repoName1", 3),
            RepoInfo(name = "repoName5", owner = "chris", url = "repoName1", 4),
            RepoInfo(name = "repoName6", owner = "chris", url = "repoName1", 5),
            RepoInfo(name = "repoName7", owner = "chris", url = "repoName1", 6),
            RepoInfo(name = "repoName8", owner = "chris", url = "repoName1", 7),
            RepoInfo(name = "repoName9", owner = "chris", url = "repoName1", 8),
            RepoInfo(name = "repoName10", owner = "chris", url = "repoName1", 9),
            RepoInfo(name = "repoName1", owner = "chris", url = "repoName1", 0),
            RepoInfo(name = "repoName2", owner = "chris", url = "repoName1", 1),
            RepoInfo(name = "repoName3", owner = "chris", url = "repoName1", 2),
            RepoInfo(name = "repoName4", owner = "chris", url = "repoName1", 3),
