...
import io.github.christianjann.gittasks.manager.generateSshKeysLib
import io.github.christianjann.gittasks.ui.destination.RemoteDestination
import io.github.christianjann.gittasks.ui.destination.RemoteDestination.AuthorizeGitTasks
import io.github.christianjann.gittasks.ui.destination.RemoteDestination.EnterUrl
import io.github.christianjann.gittasks.ui.destination.RemoteDestination.GenerateNewKeys
import io.github.christianjann.gittasks.ui.destination.RemoteDestination.PickRepo
import io.github.christianjann.gittasks.ui.destination.RemoteDestination.SelectGenerateNewSshKeys
import io.github.christianjann.gittasks.ui.destination.RemoteDestination.SelectProvider
import io.github.christianjann.gittasks.ui.destination.RemoteDestination.SelectSetupAutomatically
...
import io.github.christianjann.gittasks.ui.screen.settings.LogsScreen
    ...
    AnimatedNavHost(
        ...
        when (remoteDestination) {
            ...
            is SelectSetupAutomatically -> SelectSetupAutomaticallyScreen(
                ...
                onAutomatically = { navController.navigate(AuthorizeGitTasks) },
                onManually = { navController.navigate(EnterUrl) }
            )

            is AuthorizeGitTasks -> AuthorizeGitTasksScreen(
                onBackClick = { navController.pop() },
                authState = initState,
                onSuccess = {
